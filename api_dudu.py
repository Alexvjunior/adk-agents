...
vanessa = Agent(
    ...
    instructions=[
        ...
        "RESPOSTA SIMPLES: Use apenas send_text_message",
        ...
        "- Para perguntas simples: APENAS send_text_message",
        "- Para interesse: APENAS send_text_message oferecendo reunião",
        "- Para agendamento: send_text_message + ferramentas calendário",
        "",
